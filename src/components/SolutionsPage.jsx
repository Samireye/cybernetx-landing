  ...
  return (
    <>
      <SEOHelmet 
        ...
        description="Discover CyberNetX's suite of AI-powered healthcare solutions. From clinical documentation with CyberScribe to intelligent medical assistance with CyberMedAssist, transform your practice with our HIPAA-compliant tools."
        keywords="CyberMedAssist, CyberScribe, medical AI, clinical documentation, healthcare technology, medical transcription, practice management, HIPAA compliant"
        url="https://cybernetx.ai/solutions"
      />
